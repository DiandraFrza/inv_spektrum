...
<head>
    ...
    <title><?= $title ?></title>
    <title>Inventory Spektrum</title>
    <!-- CSS Libraries -->
...
<body>
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1"><?= $breadcrumb_title ?>
                        </h3>
                        ...
                        <div class="float-right">
                            ...
                            <form action="<?= base_url('inputs/search_time') ?>" method="POST">
                                <div class="customize-input">
                                    <input name="time"
                                        class="form-control custom-shadow custom-radius border-0 bg-white" type="search"
                                        placeholder="DD-MM-YYYY" aria-label="Search"
                                        value="<?= $this->session->userdata('time') ?>">
                                </div>
                            </form>
            ...
            <footer class="footer text-center text-muted">
                <!-- © @diandrfrzaa__ <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'>ex web</a> -->
                © diandrfrzaa__
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
    ...
    $(document).ready(function() {
        // Tambahkan event click pada tombol dropdown
        $('.has-submenu').click(function() {
            // Cari submenu terkait dengan item ini
