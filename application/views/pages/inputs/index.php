                            ...
                            <thead>
                                <tr class="border-0">
                                    ...
                                    <th class="border-0 font-14 font-weight-medium text-muted px-2 text-center">Waktu
                                        Pemasukan</th>
                                    <th class="border-0 font-14 font-weight-medium text-muted text-center">Total Harga
                                    </th>
                            ...
                            <tbody>
                                <?php foreach ($content as $row) : ?>
                                    <tr>
                                        ...
                                        <td class="border-top-0 text-center text-muted px-2 py-4">Rp.
                    ...
                    <div class="card-footer bg-white">
                        <div class="row">
                            <div class="col-md-6 col-sm-12 mb-2">
                                <a href="<?= base_url('inputs') ?>" class="btn btn-primary btn-rounded text-white"><i class="fas fa-angle-left"></i> History Barang Masuk</a>
                            </div>
