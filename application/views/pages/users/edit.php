...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Formulir Edit Data
                        <?= $input->nama ?>
                    </h4>
                                            ...
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control" name="role" id="role-options">
                                                        <option value="admin" <?= $input->role == 'admin' ? 'selected' : '' ?>>Admin
                                                        </option>
                                                        <option value="Teknisi" <?= $input->role == 'Teknisi' ? 'selected' : '' ?>>Teknisi
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control" name="status" id="status-options">
                                                        <option value="aktif" <?= $input->status == 'aktif' ? 'selected' : '' ?>>Aktif
                                                        </option>
                                                        <option value="non-aktif" <?= $input->status == 'non-aktif' ? 'selected' : '' ?>>
                                                            Non-Aktif</option>
                                                    </select>
                                                </div>
                                            </div>
