       ...
       <div class="row">
        <div class="col-md-12">
            <div class="card-group">
                <div class="card border-right mr-5">
                    <div class="card-body">
                        <div class="d-flex d-lg-flex d-md-block align-items-center">
                            <div>
                                ...
                                <a href="<?= base_url('users') ?>" class="btn">
                                    <h4 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Teknisi</h4>
                                </a>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex d-lg-flex d-md-block align-items-center">
                            <div>
                                ...
                                <a href="<?= base_url('items') ?>" class="btn">
                                    <h4 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Asset Barang</h4>
                                </a>
                            </div>
                            <div class="ml-auto mt-md-3 mt-lg-0">
                    ...
                    <div class="card-body">
                        <div class="d-flex d-lg-flex d-md-block align-items-center">
                            <div>
                                ...
                                <a href="<?= base_url('suppliers') ?>" class="btn">
                                    <h4 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Suppliers</h4>
                                </a>
                            </div>
                            <div class="ml-auto mt-md-3 mt-lg-0">
                    ...
                    <div class="card-body mr-5">
                        <div class="d-flex d-lg-flex d-md-block align-items-center">
                            <div>
                                ...
                                <a href="<?= base_url('items') ?>" class="btn">
                                    <h4 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Stok</h4>
                                </a>
                            </div>
                            <div class="ml-auto mt-md-3 mt-lg-0">
    ...
    <div class="row">
                        ...
                        <table class="table no-wrap v-middle mb-0">
                            <thead>
                                <tr class="border-0">
                                    ...
                                    <th class="border-0 font-14 font-weight-medium text-muted px-2">Nama Teknisi</th>
                                    <th class="border-0 font-14 font-weight-medium text-muted px-2 text-center">Waktu
                                        Pemasukan</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-top-0 text-center text-muted px-2 py-4">
                                            <a href="<?= base_url("inputs/detail/$row->id") ?>"
                                                class="btn btn-primary btn-rounded"><i data-feather="file-text"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <h4 class="card-title">History Barang Keluar</h4>
                    </div>
                    <div class="table-responsive">
                        <table class="table no-wrap v-middle mb-0">
                            <thead>
